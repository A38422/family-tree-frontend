  ...
  >
    ...
    >
      <FormItem label="Tên sự kiện" prop="name">
        <Input v-model="formState.name" placeholder="Nhập tên sự kiện"></Input>
      </FormItem>
      <FormItem label="Địa điểm" prop="location">
        <Input v-model="formState.location" placeholder="Nhập dịa điểm"></Input>
      </FormItem>
  ...
  computed: {
    ...
    rules() {
      return {
        ...
        location: [
          { required: true, validator: this.validateLocation, trigger: 'blur' },
        ],
      }
    },
